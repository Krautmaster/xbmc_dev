...
wget -q https://raw.github.com/Korni22/archlinux_kundenserver/master/Scripts/script_2.sh # 2. Teil des Setup-Scripts wird geladen.
...
pacstrap /mnt base{,-devel} acpid apache avahi dhcpcd fail2ban fish git htop iproute iptables lftp lynx mtr mysql nano net-tools ntp openssh php php-apache rsync screen subversion unrar unzip wget wireless_tools # Grundsystem wird installiert.
clear # Bildschirminhalt wird geleert.
...
wget -q https://raw.github.com/Korni22/archlinux_kundenserver/master/Scripts/script_3.sh & 
